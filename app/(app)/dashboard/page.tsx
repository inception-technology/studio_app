  ...
  return (
    <div className="flex flex-col w-full p-6">
      ...
      <section className="mt-8">
        <h2 className="text-sm font-bold uppercase tracking-wider text-slate-500 mb-3 ml-1">Analysis and reports</h2>
        ...
        <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 shadow-xl overflow-hidden relative">
          ...
          <div className="flex gap-5 relative z-10">
            <div className="flex-1">
              ...
              <button className="bg-organization hover:bg-organization/50 text-white text-xs font-bold px-5 py-2.5 rounded-lg flex items-center gap-2 transition-all active:scale-95 cursor-pointer">
